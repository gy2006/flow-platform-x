...
@Log4j2
@Component
public class StepStatusChangeConsumer
    extends PushConsumer<ExecutedCmd> implements ApplicationListener<StepStatusChangeEvent> {
    ...
    public void onApplicationEvent(StepStatusChangeEvent event) {
        ...
        push(topic, PushEvent.STATUS_CHANGE, cmd);
